export const es = {
  ...
  coursesDetails: {
    ...
    ratingCourse: {
      ...
      ratingCourse: 'Calificación'
    },
    reviewForm: {
      title:'Añadir comentario y calificación',
      subtitle: '¿Cómo calificaría este curso?',
      reviewTitle: 'Título del comentario',
      reviewContent: 'Comentario',
      sendButton: 'ENVIAR COMENTARIO'
    },
    teacherOverview: {
      title: 'Sobre el profesor',
      teacherRating: 'puntuación',
      reviews: 'reseñas',
  ...
  registerForm: {
    ...
    user : {
      title: 'Registrarme',
      text: 'Descubre una comunidad de apoyo de instructores en línea. Obtén acceso instantáneo a todos los recursos.'
    }
  },
  login: {
    title: 'Iniciar Sesión',
    text: 'Accede a una comunidad de apoyo de instructores en línea. obten acceso instantáneo a todos nuestros cursos y clases.',
    email: 'Correo Electrónico',
    password: 'Contraseña',
  },
  buttons: {
