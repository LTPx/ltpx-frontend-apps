  ...
  return (
    <div className={styles['content']}>
      ...
      <div className={styles['information']}>
        <h1>¿Como evaluar a mis alumnos para recibir pagos en OpenMind?</h1>
        <p>
          OpenMind provee un escritorio (dashboard) de docente completo en donde
          podrás administrar tus cursos y alumnos. Como los objetivos del curso
          y sus validaciones están establecidas desde el inicio, deberás revisar
          el trabajo del alumno, validar sus respuestas y adjuntar el material
          que valida su aprobación de los objetivos. Este material puede ser
          trabajos enviados, pruebas orales, videos o evaluaciones. Las
          validaciones siempre serán revisadas por el equipo de OpenMind y
        ...
        <p>
          ...
          situación (dentro de la plataforma) al equipo OpenMind y este revisará
          y aprobará el pago. El representante podrá luego solicitar una nueva
          evaluación o incluso tomar la clase completa de nuevo a cambio de un
          nuevo valor.
        </p>
        <p>
