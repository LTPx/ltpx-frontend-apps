      ...
      <img
        ...
        <div className={styles['information']}>
          ...
          <p>
            ...
            cuando un estímulo fuerte es sostenido y repetido a través del
          ...
          <p>
            Podemos identificar que la Potenciación de Larga Duración ha
            ocurrido porque una vez que lo has aprendido, ya no lo olvidas más.
            Lo has aprendido para toda la vida.
          </p>
          ...
          <p>
            ...
            facilitar la generación de Potenciación de Larga Duración. A través
            de motivar el uso del Aprendizaje Basado en Juegos y eliminar las
            distracciones innecesarias, el Protocolo de Transferencia de
            Aprendizaje estimula la generación de Potenciación de Larga
            Duración.
          </p>
          <h4>Con este propósito:</h4>
          <ul>
            <li>
              Los docentes son remunerados por los objetivos obtenidos y no por
              el tiempo gastado en lecciones o cátedra.
            </li>
            <li>
              Los alumnos tienen el control de su progreso y pueden avanzar
              rápido o lento según sus preferencias y habilidades.
            </li>
            <li>
              Los certificados contienen toda la información de la actividad
              sostenida para validaciones posteriores de otras instituciones y
              los registros de los padres.
            </li>
          </ul>
        </div>
      </div>
